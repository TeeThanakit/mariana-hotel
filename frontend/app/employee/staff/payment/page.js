      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-6 py-3 border-b border-gray-200 text-left text-sm font-semibold text-gray-700">Timestamp</th>
              <th className="px-6 py-3 border-b border-gray-200 text-left text-sm font-semibold text-gray-700">Payment Type</th>
              ...
              <th className="px-6 py-3 border-b border-gray-200 text-left text-sm font-semibold text-gray-700">Payment ID</th>
            </tr>
          </thead>
          <tbody>
            {filteredData.map((item, index) => (
              <tr key={item._id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                <td className="px-6 py-4 border-b border-gray-200 text-sm text-gray-700">{formatTimestamp(item.timestamp)}</td>
                <td className="px-6 py-4 border-b border-gray-200 text-sm text-gray-700">{item.paymentType}</td>
                <td className="px-6 py-4 border-b border-gray-200 text-sm text-gray-700">{item.roomPrice}</td>
                <td className="px-6 py-4 border-b border-gray-200 text-sm text-gray-700">{item.name}</td>
                <td className="px-6 py-4 border-b border-gray-200 text-sm text-gray-700">{item.paymentID}</td>
              </tr>
            ))}
          </tbody>
        </table>
